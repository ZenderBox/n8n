...
const WMS_NAV = [
  ...
  },
  {
    ...
    items: [
      { icon: 'chat',        label: 'WhatsApp', href: 'whatsapp.html',     id: 'whatsapp' },
      { icon: 'chat-bubble', label: 'WA Hub',   href: 'whatsapp-hub.html', id: 'whatsapp-hub' },
      { icon: 'phone',       label: 'Llamadas', href: 'llamadas.html',     id: 'llamadas' },
    ]
  },
  {
    section: 'IA',
    ...
    id: 'ia-section',
    items: [
      { icon: 'mail', label: 'Correos',        href: 'correos.html', id: 'correos' },
      { icon: 'gift', label: 'Primer Paquete', href: 'primer.html',  id: 'primer-paquete', coming: true },
    ]
  },
  {
    section: 'MARKETING',
    ...
    items: [
      { icon: 'bar-chart',   label: 'Lifecycle', href: 'lifecycle.html', id: 'lifecycle' },
      { icon: 'trending-up', label: 'Growth',    href: 'growth.html',    id: 'growth' },
    ]
  },
  {
    section: 'COBROS',
    ...
    id: 'cobros-section',
    items: [
      { icon: 'dollar', label: 'QuickBooks',         href: 'quickbooks.html',        id: 'quickbooks' },
      { icon: 'bank',   label: 'Depósito Agencias',  href: 'deposito-agencias.html', id: 'deposito-agencias' },
    ]
  },
  {
    section: 'CASILLERO',
    ...
    items: [
      { icon: 'plane', label: 'Despachos USA', href: 'despachos-usa.html', id: 'despachos-usa' },
    ]
  },
  {
